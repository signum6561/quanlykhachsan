...
public class DisplayCreateFrmTest {
    ...
    void testDisplayCreateFrm_valid() {
        List<GetInvoiceTypesOutputDTO> expected = new ArrayList<>();
        expected.add(new GetInvoiceTypesOutputDTO("dl", "Daily"));
        expected.add(new GetInvoiceTypesOutputDTO("hl", "Hourly"));
