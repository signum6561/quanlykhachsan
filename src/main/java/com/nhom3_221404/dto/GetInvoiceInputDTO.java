...
public class GetInvoiceInputDTO {
    ...
    public GetInvoiceInputDTO(String id, String roomId, Double price, String customerName, LocalDateTime billedDate,
    ...
    public GetInvoiceInputDTO(String id, String roomId, String customerName, Double price, LocalDateTime billedDate,
